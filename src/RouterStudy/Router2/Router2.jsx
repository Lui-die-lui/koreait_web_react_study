...
function Page1() {
  return (
    <>
      <div>
        <h1>Page1</h1>
        {/* 부모 Route의 path가 /*로 끝났기 때문에 여기서부터는 그 뒷부분의 경로를 기준으로 매칭 */}
        <Routes>
  ...
  return (
    <div>
      ...
      <Routes>
        ...
        {/* 즉, /page/page1또는 /page/page2 등에 해당하는 컴포넌트를 <Page1> 컴포넌트에서 보여준다. */}
        <Route path="/page/*" element={<Page1 />} />
        {/* Route의 element안에서 직접 중첩 <Routes>를 정의하는것도 가능 */}
        ...
        <Route
          ...
          element={
            <Routes>
              <Route path="/name1" element={<h1>lsg</h1>} />
              <Route path="/name2" element={<h1>LSG</h1>} />
            </Routes>
          }
        />
      </Routes>
